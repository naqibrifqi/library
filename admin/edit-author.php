...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
            <p><a href="dashboard.php">Dashboard</a> > <a href="manage-authors.php">Manage Authors</a> > <a href="javascript:window.location.href=window.location.href">Edit Author</a></p>
