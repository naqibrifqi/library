...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,bookdesc=:bookdesc,BookPrice=:price where id=:bookid";
