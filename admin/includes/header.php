                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Publisher <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add_publisher.php">Add Publisher</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-publisher.php">Manage Publisher</a></li>
                                </ul>
                            </li>
                            <li>
